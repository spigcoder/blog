...
我们首先通过阅读官方文档知道 gnet 原始的做法是不支持我们在业务逻辑中运行一些阻塞代码的，因为 read-compute-write 是一条路，如果我们在 compute 的时候阻塞了，那么当前 subreactor 就不可以监听连接了，这里 gnet 使用了线程池来解决这个问题，做法如图：![image-20260510214539004](/Users/x/Library/Application Support/typora-user-images/image-20260510214539004.png)

![image-20260510214548025](/Users/x/Library/Application Support/typora-user-images/image-20260510214548025.png)
